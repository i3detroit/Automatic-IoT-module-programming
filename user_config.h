...
// Should be located in ../Sonoff-Tasmota/sonoff
/*
  user_config.h - user specific configuration for Sonoff-Tasmota

  Modified by Mike Fink from original file by Theo Arends
...
#ifndef SITE           // to allow for alternate locations, mike, mark, evan, etc.
  #define STA_SSID1              "i3detroit-iot"                // [Ssid1] Wifi SSID
  #define STA_PASS1              "securityrisk"                // [Password1] Wifi password
  #define STA_SSID2              "i3detroit"                // [Ssid2] Optional alternate AP Wifi SSID
...
#ifndef MQTT_HOST
  #define MQTT_HOST              "10.13.0.22"                // [MqttHost]
#endif
...
#endif
#ifndef MQTT_GRPTOPIC
  #define MQTT_GRPTOPIC          "none"         // [GroupTopic] MQTT Group topic
#endif
...
#define WEB_PASSWORD           ""                // [WebPassword] Web server Admin mode Password for WEB_USERNAME (empty string = Disable)
  ...
  #define FRIENDLY_NAME          "Hi I am a new device"          // [FriendlyName] Friendlyname up to 32 characters used by webpages and Alexa
#endif
#define EMULATION              EMUL_NONE         // [Emulation] Select Belkin WeMo (single relay/light) or Hue Bridge emulation (multi relay/light) (EMUL_NONE, EMUL_WEMO or EMUL_HUE)

// -- Time - Up to three NTP servers in your region
#define NTP_SERVER1            "10.13.0.1"       // [NtpServer1] Select first NTP server by name or IP address (129.250.35.250)
...
// -- Location ------------------------------------
#define LATITUDE               42.453725         // [Latitude] Your location to be used with sunrise and sunset
#define LONGITUDE              -83.113690         // [Longitude] Your location to be used with sunrise and sunset
...
#ifndef APP_POWERON_STATE
  #define APP_POWERON_STATE      POWER_ALL_ON   // [PowerOnState] Power On Relay state
#endif                                          //   (POWER_ALL_OFF, POWER_ALL_ON, POWER_ALL_SAVED_TOGGLE, POWER_ALL_SAVED, POWER_ALL_ALWAYS_ON, POWER_ALL_OFF_PULSETIME_ON)
